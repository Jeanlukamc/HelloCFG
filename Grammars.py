...
html = CFG.fromstring(
    """
        ...
        BODY_CONTENT -> EMPHASIS BODY_CONTENT | UNORDERED_LIST BODY_CONTENT | ORDERED_LIST BODY_CONTENT
        BODY_CONTENT -> TEXT | HEADING | PARAGRAPH | ANCHOR | IMAGE | LINE_BREAK | HORIZONTAL_RULE | INPUT | STRONG | SPAN | EMPHASIS
        BODY_CONTENT -> UNORDERED_LIST | ORDERED_LIST
        BODY_NAME -> 'body'
        ...
        LIST_ITEM_NAME -> 'li'
        LIST_ITEM_CONTENT -> UNORDERED_LIST LIST_ITEM_CONTENT | ORDERED_LIST LIST_ITEM_CONTENT | TEXT_NESTING LIST_ITEM_CONTENT
        LIST_ITEM_CONTENT -> UNORDERED_LIST | ORDERED_LIST | TEXT_NESTING
