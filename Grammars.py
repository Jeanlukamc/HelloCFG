...
morse_grammar = CFG.fromstring(
    """
    S -> EXPRESSION S | COMPARISON S | ASSIGNMENT S | CONSTANT S | PRINT S | IF_STATEMENT S | FOR_LOOP S | WHILE_LOOP S | SWITCH_STATEMENT S
    S -> EXPRESSION | COMPARISON | ASSIGNMENT | CONSTANT | PRINT | IF_STATEMENT | FOR_LOOP | WHILE_LOOP | SWITCH_STATEMENT
