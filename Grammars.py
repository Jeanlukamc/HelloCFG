...
html = CFG.fromstring(
    """
        ...
        BODY_CONTENT -> LINE_BREAK BODY_CONTENT | HORIZONTAL_RULE BODY_CONTENT | INPUT BODY_CONTENT
        BODY_CONTENT -> TEXT | HEADING | PARAGRAPH | ANCHOR | IMAGE | LINE_BREAK | HORIZONTAL_RULE | INPUT
        BODY_NAME -> 'body'
        ...
        INLINE_ELEMENTS -> ANCHOR | IMAGE | LINE_BREAK | HORIZONTAL_RULE
