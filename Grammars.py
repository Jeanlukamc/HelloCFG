...
morse_grammar = CFG.fromstring(
    """
    S -> EXPRESSION S | COMPARISON S | ASSIGNMENT S | CONSTANT S | PRINT S | IF_STATEMENT
    S -> EXPRESSION | COMPARISON | ASSIGNMENT | CONSTANT | PRINT

    IF_STATEMENT -> IF_STATEMENT_NAME OPEN_PARENTHESIS COMPARISON CLOSE_PARENTHESIS COLON S
    IF_STATEMENT -> IF_STATEMENT_NAME COMPARISON COLON S 
    IF_STATEMENT -> IF_STATEMENT_NAME OPEN_PARENTHESIS COMPARISON CLOSE_PARENTHESIS COLON S ELSE_STATEMENT_NAME COLON S
    IF_STATEMENT -> IF_STATEMENT_NAME COMPARISON COLON S ELSE_STATEMENT_NAME COLON S
    IF_STATEMENT_NAME -> '<#..#..-.#>#'
    ELSE_STATEMENT_NAME -> '<#.#.-..#...#.#>#'
