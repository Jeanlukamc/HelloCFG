...
html = CFG.fromstring(
    """
        ...
        S -> LESS_THAN HTML MULTI_ATTRIBUTES GREATER_THAN CONTENT LESS_THAN SLASH HTML GREATER_THAN | LESS_THAN HTML MULTI_ATTRIBUTES GREATER_THAN LESS_THAN SLASH HTML GREATER_THAN
        LESS_THAN -> '<'
        GREATER_THAN -> '>'
        SLASH -> '/'
        HTML -> 'html'
