...
morse_grammar = CFG.fromstring(
    """
    S -> EXPRESSION S | COMPARISON S | ASSIGNMENT S | CONSTANT S | PRINT S | IF_STATEMENT S | FOR_LOOP S | WHILE_LOOP S | SWITCH_STATEMENT S | FUNCTION_DEFINITION S | FUNCTION_CALL S
    S -> EXPRESSION | COMPARISON | ASSIGNMENT | CONSTANT | PRINT | IF_STATEMENT | FOR_LOOP | WHILE_LOOP | SWITCH_STATEMENT | FUNCTION_DEFINITION | FUNCTION_CALL

    FUNCTION_DEFINITION -> FUNCTION_NAME VARIABLE OPEN_PARENTHESIS CLOSE_PARENTHESIS COLON FUNCTION_INSIDE
    FUNCTION_DEFINITION -> FUNCTION_NAME VARIABLE OPEN_PARENTHESIS PARAMETERS CLOSE_PARENTHESIS COLON FUNCTION_INSIDE
    
    
    FUNCTION_INSIDE -> OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_CONTENT -> S FUNCTION_CONTENT | FUNCTION_IF_STATEMENT FUNCTION_CONTENT | FUNCTION_SWITCH_STATEMENT FUNCTION_CONTENT | RETURN_STATEMENT S
    FUNCTION_CONTENT -> S | FUNCTION_IF_STATEMENT | FUNCTION_SWITCH_STATEMENT | RETURN_STATEMENT
    FUNCTION_IF_STATEMENT -> IF_STATEMENT
    FUNCTION_IF_STATEMENT -> IF_STATEMENT_NAME OPEN_PARENTHESIS COMPARISON CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_IF_STATEMENT -> IF_STATEMENT_NAME COMPARISON COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_IF_STATEMENT -> IF_STATEMENT_NAME COMPARISON COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET ELSE_STATEMENT_NAME COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_SWITCH_STATEMENT -> SWITCH_STATEMENT
    FUNCTION_SWITCH_STATEMENT -> SWITCH_STATEMENT_NAME SWITCH_VARIABLE COLON OPEN_CURLY_BRACKET FUNCTION_CASES CLOSE_CURLY_BRACKET
    FUNCTION_SWITCH_STATEMENT -> SWITCH_STATEMENT_NAME OPEN_PARENTHESIS SWITCH_VARIABLE CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET FUNCTION_CASES CLOSE_CURLY_BRACKET
    FUNCTION_CASES -> FUNCTION_CASE FUNCTION_CASES | FUNCTION_CASE
    FUNCTION_CASE -> CASE_NAME SWITCH_VARIABLE COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_CASE -> CASE_NAME OPEN_PARENTHESIS SWITCH_VARIABLE CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_CASE -> CASE_NAME SWITCH_VARIABLE COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT BREAK_NAME CLOSE_CURLY_BRACKET
    FUNCTION_CASE -> CASE_NAME OPEN_PARENTHESIS SWITCH_VARIABLE CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT BREAK_NAME CLOSE_CURLY_BRACKET
    FUNCTION_CASE -> DEFAULT_NAME COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT CLOSE_CURLY_BRACKET
    FUNCTION_CASE -> DEFAULT_NAME COLON OPEN_CURLY_BRACKET FUNCTION_CONTENT BREAK_NAME CLOSE_CURLY_BRACKET
    FUNCTION_NAME -> '<#-..#.#..-.#>#'
    RETURN_STATEMENT -> RETURN_NAME OPEN_PARENTHESIS PARAMETERS CLOSE_PARENTHESIS | RETURN_NAME PARAMETERS
    RETURN_NAME -> '<#.-.#.#-#..-#.-.#-.#>#'

    FUNCTION_CALL -> VARIABLE OPEN_PARENTHESIS PARAMETERS CLOSE_PARENTHESIS | VARIABLE OPEN_PARENTHESIS CLOSE_PARENTHESIS
    PARAMETERS -> SINGLE_PARAMETER COMMA PARAMETERS | SINGLE_PARAMETER
    SINGLE_PARAMETER -> ASSIGNMENT | VARIABLE | STRING | DIGITS | COMPARISON | EXPRESSION | FUNCTION_CALL

    SWITCH_STATEMENT -> SWITCH_STATEMENT_NAME SWITCH_VARIABLE COLON OPEN_CURLY_BRACKET SWITCH_CASES CLOSE_CURLY_BRACKET
    SWITCH_STATEMENT -> SWITCH_STATEMENT_NAME OPEN_PARENTHESIS SWITCH_VARIABLE CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET SWITCH_CASES CLOSE_CURLY_BRACKET
    SWITCH_VARIABLE -> VARIABLE | STRING | DIGITS
    SWITCH_CASES -> CASE SWITCH_CASES | CASE
    CASE -> CASE_NAME SWITCH_VARIABLE COLON OPEN_CURLY_BRACKET S CLOSE_CURLY_BRACKET
    CASE -> CASE_NAME OPEN_PARENTHESIS SWITCH_VARIABLE CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET S CLOSE_CURLY_BRACKET
    CASE -> CASE_NAME SWITCH_VARIABLE COLON OPEN_CURLY_BRACKET S BREAK_NAME CLOSE_CURLY_BRACKET
    CASE -> CASE_NAME OPEN_PARENTHESIS SWITCH_VARIABLE CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET S BREAK_NAME CLOSE_CURLY_BRACKET
    CASE -> DEFAULT_NAME COLON OPEN_CURLY_BRACKET S CLOSE_CURLY_BRACKET
    CASE -> DEFAULT_NAME COLON OPEN_CURLY_BRACKET S BREAK_NAME CLOSE_CURLY_BRACKET
    CASE_NAME -> '<#-.-.#.-#...#.#>#'
    DEFAULT_NAME -> '<#-..#.#..-.#.-#..-#.-..#-#>#'
    BREAK_NAME -> '<#-...#.-.#.#.-#-.-#>#'
    SWITCH_STATEMENT_NAME -> '<#...#.--#..#-#-.-.#....#>#'

    WHILE_LOOP -> WHILE_LOOP_NAME COMPARISON COLON OPEN_CURLY_BRACKET S CLOSE_CURLY_BRACKET
    WHILE_LOOP -> WHILE_LOOP_NAME OPEN_PARENTHESIS COMPARISON CLOSE_PARENTHESIS COLON OPEN_CURLY_BRACKET S CLOSE_CURLY_BRACKET
    WHILE_LOOP_NAME -> '<#.--#....#..#.-..#.#>#'
    ...
    RANGE_CONTENT -> DIGITS | DIGITS COMMA DIGITS | DIGITS COMMA DIGITS COMMA DIGITS
    FOR_LOOP_NAME -> '<#..-.#---#.-.#>#'
    IN_NAME -> '<#..#-.#>#'
    RANGE_NAME -> '<#.-.#.-#-.#--.#.#>#'
    ...
    ASSIGNMENT -> VARIABLE EQUALS EXPRESSION | VARIABLE EQUALS FUNCTION_CALL
    EQUALS -> '<#.#--.-#..-#.-#.-..#...#>#'

    COMPARISON -> EXPRESSION EQUALS EQUALS EXPRESSION | EXPRESSION GREATER_THAN EXPRESSION | EXPRESSION LESS_THAN EXPRESSION
    GREATER_THAN -> '<#--.#.-.#.#.-#-#.#.-.#>#'
    LESS_THAN -> '<#.-..#.#...#...#>#'
