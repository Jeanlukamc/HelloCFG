...
html = CFG.fromstring(
    """
        ...
        BODY_CONTENT -> TEXT BODY_CONTENT | HEADING BODY_CONTENT | PARAGRAPH BODY_CONTENT | ANCHOR BODY_CONTENT
        BODY_CONTENT -> TEXT | HEADING | PARAGRAPH | ANCHOR
        BODY_NAME -> 'body'
